...
data.forEach(element=>{
  let dat = L.marker([element.geometry.coordinates[1] / 10000, element.geometry.coordinates[0] / 10000], {icon:treeIcon});
dat.bindTooltip(`<b>id</b>: ${iterator} <br> <b>koordynaty</b>: ${element.geometry.coordinates[1].toFixed(2) / 10000}, ${element.geometry.coordinates[0].toFixed(2) / 10000}`);
iterator++;
